...
/email unsubscribe-candidates # list senders sorted by inbox archive count
...
- `email_collect_unsubscribe_candidates` — groups recent inbox messages containing unsubscribe text by sender, extracts candidate unsubscribe URLs/mailtos, and reports how many inbox messages would be archived
